...
from GuideToExile.exceptions import SkillTreeLoadingException, PastebinImportException, TreeParsingException
from GuideToExile.models import BuildGuide
from GuideToExile.scripts import ladder_imports, guide_import
...
class PobImportTests(SimpleTestCase):
    ...
    @parameterized.expand([
        ('https://pastebin.com/Hi8wdMN7'),
        ('https://pastebin.com/zbZZiuHd'),
        ('https://pastebin.com/3FXUNCNb'),
        ('https://pastebin.com/NLV5E7t2'),
        ('https://pastebin.com/Y0VK5Ck4', TreeParsingException),
        ('https://pastebin.com/hcZYf9hf', TreeParsingException),
        ('https://pastebin.com/zC8dxG7Z'),
        ('https://pastebin.com/2GzHKJ6F'),
        ('https://pastebin.com/y74AfAuL'),
        ('https://pastebin.com/SHbGfmMc'),
        ('https://pastebin.com/prYC7vAc'),
        ('https://pastebin.com/r8gwUkMg'),
        ('https://pastebin.com/UehErcXC'),
        ('https://pastebin.com/DmciSAZb'),
        ('https://pastebin.com/4Mw0r1Vt', TreeParsingException),
        ('https://pastebin.com/2hJJPfVD', TreeParsingException),
        ('https://pastebin.com/H9tcdfJw'),
        ('https://pastebin.com/EWi50dRx', TreeParsingException),
        ('https://pastebin.com/BkswUTk8'),
        ('https://pastebin.com/e0wKHhxe'),
        ('https://pastebin.com/5AgFPtv8'),
        ('https://pastebin.com/uMwJmgpE'),
        ('https://pastebin.com/pmDLtwCr', TreeParsingException),
        ('https://pastebin.com/AEpdqBkx'),
        ('https://pastebin.com/jUbrKkdq', TreeParsingException),
        ('https://pastebin.com/H9tcdfJw'),
        ('https://pastebin.com/zC8dxG7Z'),
        ('https://pastebin.com/2GzHKJ6F'),
        ('https://pastebin.com/3FXUNCNb'),
    ])
    def test_import_build(self, pastebin_url, exception_cls=None):
        if exception_cls:
            with self.assertRaises(exception_cls):
                base64_build = pob_import.import_from_pastebin(pastebin_url)
                xml_build = pob_import.base64_to_xml(base64_build)
                _ = pob_import.parse_pob_details(xml_build)
        else:
            base64_build = pob_import.import_from_pastebin(pastebin_url)
            xml_build = pob_import.base64_to_xml(base64_build)
            _ = pob_import.parse_pob_details(xml_build)

    def test_import_build_single(self):
        base64_build = pob_import.import_from_pastebin("https://pastebin.com/zC8dxG7Z")
        xml_build = pob_import.base64_to_xml(base64_build)
        _ = pob_import.parse_pob_details(xml_build)
        print(_)
...
class TestGuideImport(TestCase):
    def test(self):
        user = guide_import.make_importing_user()
        url = 'https://www.pathofexile.com/forum/view-thread/3129675'
        data = guide_import.scrape_guide_thread(url)
        guide_import.make_new_guide(data, user)
        self.assertEqual(2, BuildGuide.objects.count())
