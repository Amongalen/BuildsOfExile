...
urlpatterns = [
    ...
    path('guide/edit_pob/<int:pk>/', login_required(views.edit_pob_view), name='edit_pob'),
    path('guide/cancel_edit/<int:pk>/', login_required(views.cancel_edit_view), name='cancel_edit'),
