...
from BuildsOfExile.models import SkillGem, SkillGroup, TreeSpec, ItemSet, Item
    ...
    for item_set_xml in xml_root.find('Items').findall('ItemSet'):
        ...
        for slot_xml in item_set_xml:
            ...
            if item_id != 0:
                ...
                slots.append((slot_name, item_id))
...
def extract_skills(xml_root):
    ...
    for group_xml in xml_root.find('Skills'):
        ...
        skill_groups.append(SkillGroup(is_enabled=is_group_enabled,
                                       main_active_skill_index=int(group_xml.get('mainActiveSkill')),
                                       gems=gems))
    ...
    main_active_skill = skill_groups[main_socket_group_index].gems[main_skill_index_within_group].name
